...
import { mail } from "../../assets/img/img";
    ...
    <>
        <motion.div variants={fadeIn("up", "spring", 0.5, 2)} className="w-full">
            ...
            <div className="md:mt-[100px] my-5">
                <span className="text-[40px] text-black font-light">Schedule</span>
                {/*LINE DISPLAYED*/}
                <div className='h-[1px] w-full bg-black' />
                <div className="flex my-[100px] flex-col gap-[25px] text-black items-center md:text-[30px] text-[20px] font-light">
                    <p className="w-fit">Monday-Friday: 6 am - 3 pm</p>
                    <p className="w-fit">Saturday-Sunday: Closed</p>
                </div>
            </div>
        </motion.div>
    </>
  ...
  export default SectionWrapper(ContentContactEN,"contact");